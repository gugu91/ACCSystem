...
typedef struct {
  ...
  real_T Delay3_DSTATE;                /* '<S5>/Delay3' */
...
struct P_ACC_Controller_T_ {
  ...
  real_T Constant_Value_m;             /* Expression: 5
                                        ...
                                        */
  real_T Constant1_Value_e;            /* Expression: 195
...
extern void ACC_Controller_initialize(RT_MODEL_ACC_Controller_T *const
  ...
  *ACC_Controller_U_PedalFlag, real_T *ACC_Controller_U_Distance, real_T
  ...
  *ACC_Controller_Y_Stop, uint8_T *ACC_Controller_Y_Led1);
 ...
 * '<S4>'   : 'ACCSystem/ACC_Controller/Range&Age Checks'
 * '<S5>'   : 'ACCSystem/ACC_Controller/Speed Average'
 * '<S6>'   : 'ACCSystem/ACC_Controller/controller'
 * '<S7>'   : 'ACCSystem/ACC_Controller/Range&Age Checks/Age Checks'
 * '<S8>'   : 'ACCSystem/ACC_Controller/Range&Age Checks/Range Checks'
 * '<S9>'   : 'ACCSystem/ACC_Controller/Range&Age Checks/Range Checks/Check Flag1'
 * '<S10>'  : 'ACCSystem/ACC_Controller/Range&Age Checks/Range Checks/Check Switch'
 */

...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ACC_Controller
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = ACC_Controller_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ACC_Controller
...
INCLUDES_BUILDINFO = -I$(START_DIR)/ACC_Controller_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ACC_Controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/ACC_Controller_ert_rtw/ACC_Controller.c $(START_DIR)/ACC_Controller_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/ACC_Controller_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ACC_Controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

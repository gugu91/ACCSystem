###########################################################################
## Makefile generated for Simulink model 'ACCSystem'. 
## 
## Makefile     : ACCSystem.mk
## Generated on : Tue Jul 07 19:19:27 2015
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ACCSystem
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Gugu/Documents/MATLAB/MBSDTest2
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = ACCSystem_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ACCSystem
...
INCLUDES_BUILDINFO = -I$(START_DIR)/ACCSystem_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ACCSystem -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/ACCSystem_ert_rtw/ACCSystem.c $(START_DIR)/ACCSystem_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/ACCSystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ACCSystem_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
